...
| `module_idx` | 예 | 고객 모듈 ID | `고객` | 실제 모듈 이름; API 설정값이 있으면 그 값을 우선 |
...
| `module_idx` | 예 | 프로젝트 모듈 ID | `프로젝트` | 실제 모듈 이름; API 설정값이 있으면 그 값을 우선 |
...
| `module_idx` | 예 | 서비스 모듈 ID | `서비스` | 실제 모듈 이름; API 설정값이 있으면 그 값을 우선 |
